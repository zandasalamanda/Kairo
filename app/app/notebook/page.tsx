...
export const metadata: Metadata = { title: "Notebook · Aether" };
...
export default async function NotebookPage({ searchParams }: { searchParams: Promise<{ goal?: string }> }) {
  ...
  return (
    <PageContainer user={user}>
      <PageHeader title="Notebook" description="Context and thoughts for each goal — Aether uses these when you ask or break down a step." />
