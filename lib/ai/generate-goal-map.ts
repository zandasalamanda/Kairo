...
STEP TITLES stay short — they label the map — a concrete first action like "Draft the 3 core screens in Figma", never a vague theme like "Design". The "description" is where you HOLD THEIR HAND: 2-4 sentences that are genuinely useful on their own — exactly what to do, how to do it, and a real example or concrete number so they can act with zero further research. Never vague filler like "quick wins fund the goal".
